...
public interface RequestAnswerMatcher<M> {
     ...
     * case there is no need to try to match it with requests waiting for an answer.</p>
     *
     ...
     * optional containing a {@link fpc.tools.fp.TryResult}. A <code>TryResult</code> is used since the received message
