...
public class FXAddTabPaneSkin extends TabPaneSkin {
  ...
  private @Nullable ButtonSize buttonSize;
  ...
  public FXAddTabPaneSkin(FXAddTabPane fxAddTabPane) {
    ...
    this.addTabButton = this.createAddButton();
  ...
  private Button createAddButton() {
    final var addTabButton = new Button();
    addTabButton.getStyleClass().add("add-button");
